...
const faqs: FAQItem[] = [
    ...
    },
    {
        ...
        answer:
            "No. The system is designed for both beginners and experienced traders. Beginners can start with a demo account, while professionals can customize risk settings.",
    },
    {
        question: "Can I try the system before going live?",
        answer:
            "Yes. We recommend starting with a demo account so you can see real trades, performance, and behavior before using a live account.",
    },
];
